...
export const wordChainItems: WordChainItem[] = [
  ...
  { id: "wc-7",  originalSentence: "Aurinko paistoi koko päivän",          chainedSentence: "Aurinkopaistoikokopäivän" },
  { id: "wc-8",  originalSentence: "Kirja oli pöydällä auki",              chainedSentence: "Kirjaolipöydälläauki" },
  ...
  { id: "wc-11", originalSentence: "Sää oli kylmä ja tuulinen",            chainedSentence: "Sääolikylmäjatuulinen" },
  ...
  { id: "wc-14", originalSentence: "Tyttö piirsi kuvan väreillä",          chainedSentence: "Tyttöpiirsikuvanväreillä" },
  { id: "wc-15", originalSentence: "Isä luki lapsille iltasadun",          chainedSentence: "Isälukilapsilleiltasadun" },
  { id: "wc-16", originalSentence: "Kaupasta ostettiin maitoa ja leipää",  chainedSentence: "Kaupastaostettiinmaitoajaleipää" },
  { id: "wc-17", originalSentence: "Lintu lauloi puun oksalla",            chainedSentence: "Lintulauloipuunoksalla" },
  { id: "wc-18", originalSentence: "Lapsi nukkui sikeästi koko yön",       chainedSentence: "Lapsinukkuisikeästikokoyön" },
  { id: "wc-19", originalSentence: "Järvessä ui paljon kaloja",            chainedSentence: "Järvessäuipaljonkaloja" },
  { id: "wc-20", originalSentence: "Opettaja kirjoitti taululle tehtävän", chainedSentence: "Opettajakirjoittitaululletehtävän" },
  { id: "wc-21", originalSentence: "Talvella lumi peitti maan",            chainedSentence: "Talvellalumipeittimaan" },
